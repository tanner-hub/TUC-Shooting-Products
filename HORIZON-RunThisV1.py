...
#
#Corrections Needed - Program needs to run relays correcltly and tested. Buttons and Relays seem to work
#
...
#
    ...
    while GPIO.input(b1) == True:#
        ...
        time.sleep(0.1) #This is the only time the default sleep function should be called
        #
...
#
#Swap position based on globally declared direction variable
def swapPosition():#
    global direction#
    if direction == 1:#
        GPIO.output(r1, True)#
        GPIO.output(r3, True)#
        mySleep(1) #Just a guess, needs to be tested and adjusted
