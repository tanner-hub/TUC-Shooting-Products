...
#motor can be ran in randomly alternating directions for random time intervals with an index perimeter limiting
...
#Declorations for relay ports
r1 = 16
r2 = 18
r3 = 15
r4 = 13

#Declorations for button ports
b1 = 33
b2 = 35
b3 = 37
...
GPIO.setup(b0, GPIO.IN, pull_up_down=GPIO.PUD_UP)
